...
ms.locfileid: "137943321"
---
# <a name="module-10---lab-1---exercise-1---configure-office-365-message-encryption"></a>모듈 10 - 랩 1 - 연습 1 - Office 265 메시지 암호화 구성
...
### <a name="task-1--enable-azure-rights-management-for-exchange-online"></a>작업 1 - Exchange Online에서 Azure 권한 관리를 사용하도록 설정
...
### <a name="task-2--create-a-mail-flow-encryption-rule-using-the-exchange-admin-center"></a>작업 2 - Exchange 관리 센터를 사용하여 메일 흐름 암호화 규칙 만들기
...
5. **Exchange 관리 센터** 의 왼쪽 탐색 창에서 **메일 흐름** 을 선택하고 **규칙** 을 선택합니다.

6. **규칙** 탭에서 더하기 기호( **+** )를 선택하여 새 규칙을 만듭니다. 그러면 작업을 선택할 수 있는 드롭다운 메뉴가 표시됩니다. **새 규칙 만들기** 를 선택합니다.

7. **새 규칙** 창의 **이름** 상자에 이 규칙의 이름으로 `Encrypt mail for guest@contoso.com`을 입력합니다.
...
14. 이제 이 규칙이 적용되는 경우 수행할 작업을 정의해야 합니다. **다음 작업 수행...** 상자에서 드롭다운 화살표를 선택합니다. 드롭다운 메뉴에서 **메시지 보안 수정...** 을 선택합니다. 메뉴가 표시되면 **Office 365 메시지 암호화 및 권리 보호 적용** 을 선택합니다.
